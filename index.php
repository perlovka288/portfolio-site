...
<main class="container portfolio-stage">
    ...
    <?php
        ...
        // SVG заглушка (data-uri, встраивается прямо в onerror)
        $fallbackSvg = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3E%3Crect width='16' height='16' fill='%231a1a1a'/%3E%3C/svg%3E";
    ?>
