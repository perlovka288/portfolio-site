 ...
 * Полностью автономная стабильная сборка API v1.
 */
    ...
    window.fetch = async function(...args) {
        ...
        if (typeof url === 'string' && url.includes('ai_support.php') && options && options.method === 'POST') {
            try {
                ...
                // Формируем историю переписки для v1
                let contents = [];
                ...
                // Исправленная структура JSON под требования Google API v1
                ...
                if (geminiData.error) {
                    return new Response(JSON.stringify({ ok: false, reply: 'Ошибка конфигурации ИИ. Пожалуйста, обновите страницу.' }), { status: 200 });
                }
